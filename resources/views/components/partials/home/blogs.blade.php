<section class="flex justify-center">
    <div class="container h-[calc(100vh-64px)] relative flex items-end">
        ...
        <a href="media/detail-media/{{ $media->slug }}"
            class="z-[10] relative w-full px-[24px] lg:px-[200px] py-[16px] lg:py-[40px] flex flex-col gap-[16px] lg:gap-[32px] justify-center bg-white-first-70 hover:bg-white-first hover:underline active:underline transition-all duration-300 ease-in-out">
